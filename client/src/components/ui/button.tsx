...
const variants = {
  ...
  ghost: "bg-transparent text-gray-800 hover:bg-gray-200 focus:ring-gray-400 dark:text-gray-300 dark:hover:bg-gray-700",
  outline: "border border-gray-400 bg-white text-gray-800 hover:bg-gray-200 hover:border-blue-400 focus:ring-gray-400 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700",
};
